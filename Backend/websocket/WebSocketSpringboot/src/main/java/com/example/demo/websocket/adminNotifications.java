...
@ServerEndpoint("/Adminchat/{username}")
@Component
public class adminNotifications {
    ...
    @OnOpen
    public void onOpen(Session session, @PathParam("AdminUserName") String username) throws IOException {
        ...
        if (usernameSessionMap.containsKey(username)) {
            ...
            sessionUsernameMap.put(session, username);
            usernameSessionMap.put(username, session);
            broadcast("Admin: " + username + " has joined");
            broadcastActiveUsers();
        }
    }
    ...
    public void onClose(Session session) throws IOException {
        ...
        sessionUsernameMap.remove(session);
        usernameSessionMap.remove(username);
        broadcast("Admin " + username + " has disconnected");
        broadcastActiveUsers();
    }
    ...
    private void sendMessageToParticularUser(String username, String message) {
        try {
            ...
            logger.error("Failed to send message to user, user not found " + username, e);
        }
    }
